...
\subsection{Esaminazione Studio di Fattibilità}
	Il documento in questione viene letto da tutti i partecipanti del team duckware, vengono fatti notare alcuni punti di stesura, \markg{verifica}to e approvato.
...
\subsection{Discussione linguaggi e tecnologie}
	...
	\begin{itemize}
		\item App per iOS e \markg{Android}
			\begin{itemize}
				\item Delphi

...
\paragraph{MPRCS006 - Misurazione dei test}\mbox{}\\[0.4cm]
\begin{center}
	\centering
	\renewcommand{\arraystretch}{1.5}
	\rowcolors{3}{tableLightYellow}{}
...
\end{figure}
\paragraph{MPRCS007 - Copertura requisiti}\mbox{}\\[0.4cm]
In questa revisione la copertura dei requisiti è pari al DA CALCOLARE\%, valore considerato accettato per tale revisione.
\paragraph{MPRDS014 - Code Coverage}\mbox{}\\[0.4cm]
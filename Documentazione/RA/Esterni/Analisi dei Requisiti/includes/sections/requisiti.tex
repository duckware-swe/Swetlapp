...
Non sono stati individuati requisiti prestazionali in quanto la maggior parte delle attività, per essere concluse, necessitano di una interazione con i servizi di AWS e quindi i tempi non risultano costanti o prevedibili con precisione.
Qualsiasi operazione effettuata ha un tempo di soddisfacimento influenzato dal carico della rete nel momento della richiesta.
...
\begin{center}
	\renewcommand{\arraystretch}{1.5}
	\rowcolors{3}{tableLightYellow}{}
	\begin{longtable}{  >{\RaggedRight}p{2cm}  
						>{\Centering}p{2cm} 
						>{\Centering}p{2.2cm}  
						>{\Centering}p{1.8cm} 
						>{\Centering}p{1.2cm}

...
\begin{center}
	...
	\begin{longtable}{  >{\RaggedRight}p{.8cm}  
			...
			3.1.0 & 2019-05-07 & \andrea & Verificatore & \verifica{documento}\\
			3.0.7 & 2019-05-03 & \matteo & Analista & \correzione{\addref{sec:iterazione_vocale_utente} rimosse interazioni vecchie}\\	
			3.0.6 & 2019-05-03 & \alessandro & Analista & \correzione{\addref{sec:user_case} immagini}\\
			3.0.5 & 2019-05-02 & \andrea & Verificatore & \verifica{\addref{sec:requisiti} e \addref{sec:user_case}}\\
			3.0.4 & 2019-05-01 & \luca & Analista & \correzione{\addref{sec:requisiti} modificati requisiti riferiti ad API Gateway per cambio di piattaforma (Amplify)}\\
			3.0.3 & 2019-04-28 & \sonia & Analista & \correzione{\addref{sec:user_case}. Rimossi connettori non implementati}\\
